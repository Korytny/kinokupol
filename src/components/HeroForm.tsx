...
const HeroForm = () => {
  ...
  return (
    <section className="relative h-[700px] overflow-hidden">
      ...
      >
        <div className="absolute inset-0 section-dark opacity-80"></div>
      </div>

      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white">
        <h1 className="text-5xl md:text-7xl font-bold mb-4 animate-fade-in section-title">
          КиноКупол
        </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex flex-col">
              ...
              <Input 
                ...
                className="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#80dfd5] text-slate-800"
              />
            </div>
            
            <div className="flex flex-col">
              <label className="text-slate-800 font-medium mb-1 text-left">Формат</label>
              <Input 
                type="text" 
            ...
            <div className="flex flex-col">
              <label className="text-slate-800 font-medium mb-1 text-left">Количество гостей</label>
              <Input 
                type="number" 
