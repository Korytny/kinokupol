...
const DomeTestimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: "Презентация нашего нового продукта в куполе L произвела фурор среди партнеров и клиентов. Техническая поддержка команды КиноСфера была на высшем уровне.",
      rating: 4
    }
  ];
