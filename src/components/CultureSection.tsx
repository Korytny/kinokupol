    ...
    <section className="py-16 bg-gradient-to-r from-slate-900 to-blue-900 text-white overflow-hidden">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-light mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-teal-200">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-10 mb-16 border border-white/20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              ...
              <div className="text-blue-100">крупных музеев используют наши решения</div>
            </div>
            <div className="p-4 md:border-x border-white/20">
              <div className="text-4xl font-light text-teal-200 mb-2">1.5M</div>
              <div className="text-blue-100">посетителей за последний год</div>
            </div>
            <div className="p-4">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={index} className="flex">
                  <div className="mr-6 text-lg font-medium text-blue-300 w-16">{event.year}</div>
                  <div>
                    <h4 className="text-lg font-medium text-blue-100 mb-1">{event.title}</h4>
          ...
          <div className="md:w-1/2">
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 right-4 p-4 bg-white/10 backdrop-blur-sm rounded border border-white/20">
                <div className="text-sm text-blue-300">Международный проект</div>
